      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-50 text-rose-700 text-xs font-bold uppercase tracking-wider mb-3 border border-rose-200">
            <AlertTriangle className="w-3.5 h-3.5" /> The Pain Loop Cycle
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {traps.map((trap, idx) => {
            ...
            return (
              <div
                key={idx}
                className="relative bg-[#FAFBFD] p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`text-xs font-semibold px-2.5 py-1 rounded-md ${trap.tagColor}`}>
                      {trap.tag}
                    </span>
                  </div>
                  ...
                  <p className="text-xs font-medium text-rose-700 bg-rose-50/70 p-2 rounded-lg mb-3 italic">
                    "{trap.hindiQuote}"
                  </p>
        ...
        <div className="mt-12 bg-gradient-to-r from-[#072B34] to-[#0B4351] text-white rounded-3xl p-6 sm:p-10 shadow-xl border border-teal-900/40 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center space-y-4">
            ...
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight">
              "Generic exercises aur temporary treatments kuch time relief de sakte hain, lekin root cause ke bina pain dobara trigger hoga."
            </h3>
            ...
            <div className="pt-2 flex justify-center">
              <a
                href="#framework"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-[#0B4351] hover:bg-teal-50 font-bold text-sm transition-all shadow-md"
              >
