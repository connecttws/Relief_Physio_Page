...
import { Calendar, Phone, User, Clock, ShieldCheck, CheckCircle2, ArrowRight, Sparkles } from 'lucide-react';
...
export default function BookingForm() {
  ...
  return (
    <section id="consultation" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-white via-[#F4F8F8] to-[#EBF3F5] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl border border-slate-200 shadow-2xl overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-[#072B34] to-[#0B4351] text-white p-5 sm:p-8 md:p-10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl sm:text-2xl md:text-3xl font-extrabold leading-tight mb-3 sm:mb-4">
                  Apna Consultation Slot Confirm Karein
                </h3>

                <p className="text-slate-200 text-xs sm:text-sm leading-relaxed mb-6">
                  &ldquo;Aapko pain ke saath compromise karte rehne ki zarurat nahi hai. Har baar temporary painkillers lene ke bajay ek proper assessment karwayein.&rdquo;
                </p>

                <div className="space-y-3.5 text-xs sm:text-sm text-slate-200 pt-3 border-t border-teal-800/60">
              ...
              <div className="mt-8 pt-5 border-t border-teal-800/60">
                <p className="text-xs text-teal-300 font-semibold mb-1">Clinic Contact Helpline:</p>
                <a href="tel:+919829000000" className="text-base sm:text-lg font-bold text-white hover:text-emerald-300 transition-colors">
                  +91 98290 XXXXX
                </a>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 p-5 sm:p-8 md:p-10 bg-white">
              {submitted ? (
                <div className="text-center py-10 space-y-4">
                  ...
                  <div className="pt-4">
                    <button
                      ...
                      className="px-6 py-2.5 rounded-full text-xs font-bold text-[#0B4351] bg-teal-50 hover:bg-teal-100 transition-colors cursor-pointer"
                    >
                      Book Another Slot
                    </button>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 sm:py-3 rounded-xl border border-slate-300 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#0D9488] focus:border-transparent transition-all"
                      />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2.5 sm:py-3 rounded-xl border border-slate-300 text-xs sm:text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#0D9488] focus:border-transparent transition-all"
                      >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      <button
                        ...
                        className={`p-2.5 sm:p-3 rounded-xl text-xs sm:text-sm font-semibold border transition-all text-center cursor-pointer ${
                  ...
                  <div className="pt-2">
                    <button
                      type="submit"
                      className="btn-accent w-full py-3.5 sm:py-4 rounded-xl text-sm sm:text-base font-extrabold flex items-center justify-center gap-2 group shadow-xl cursor-pointer"
                    >
                      <Calendar className="w-4 h-4 sm:w-5 sm:h-5" />
                      <span>Confirm Consultation Slot Today</span>
                      <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" />
                    </button>
                    <p className="text-center text-[10px] sm:text-[11px] text-slate-600 mt-2 font-medium">
